...
async function generatePDF() {
  ...
  // 2️⃣ Заголовок
  doc.setFontSize(16)
  const headerText = 'АКТ приема товара'
const pageWidth = doc.internal.pageSize.getWidth()

// Простейшее центрирование: берём середину страницы и немного отступаем от X = pageWidth / 2
// Текст будет не идеально центрирован, но точно не упадет
doc.setFontSize(16)
doc.text(headerText, pageWidth / 4, 15)  // или pageWidth * 0.25, подбираем визуально
doc.text(text, x, 15)                       // 15 — координата Y
