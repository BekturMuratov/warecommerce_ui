...
async function generatePDF() {
  ...
  // 1️⃣ Загружаем шрифт
  await loadFont(doc)  // твоя функция, которая добавляет и устанавливает Roboto

  // 2️⃣ Заголовок
  doc.setFontSize(16)
  doc.text('АКТ приема товара', 14, 15) // без align, безопасно для кириллицы
  doc.setFontSize(12)
  ...
  autoTableModule.default(doc, {
    ...
    body: tableRows,
    startY: 40,
    styles: { fontSize: 10, font: 'Roboto' }, // тот же шрифт
