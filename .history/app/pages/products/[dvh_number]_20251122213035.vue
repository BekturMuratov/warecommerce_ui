...
async function generatePDF() {
 ...
 const fontFileUrl = '/fonts/Roboto-Regular.ttf' // положи в public/fonts
 const fontBuffer = await fetch(fontFileUrl).then(res => res.arrayBuffer())
 doc.addFileToVFS('Roboto-Regular.ttf', fontBuffer)
 doc.addFont('Roboto-Regular.ttf', 'Roboto', 'normal')
 doc.setFont('Roboto') // используем для текста и таблицы
