<template>
 ...
 >
  ...
  />
           ...
           <v-card-actions>
       <v-spacer />
       <v-btn variant="tonal" @click="showPdfModal = false">Отмена</v-btn>
       <v-btn color="success" @click="addProductFromModal">Сохранить товары в базу</v-btn>
     </v-card-actions>
         </div>
       </div>
     </v-card-text>
...
const updateValue = (rowIndex, key, value) => {
